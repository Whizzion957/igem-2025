...
const Pages: (Page | Folder)[] = [
  ...
  },
  {
    ...
    folder: [
      {
        name: "Description",
        title: "Dry Lab Description",
        path: "/drylab-description",
        component: DryLabDescription,
        lead: "Describing our drylab work. This page should give an overview of the work that was done in the dry lab for the project.",
      },
      {
        name: "Model",
        title: "Model",
